...
interface VideoRequestInputProps {
  onRequestSubmit: (request: string) => void;
}

export const VideoRequestInput = ({ onRequestSubmit }: VideoRequestInputProps) => {
  ...
  const handleSubmitRequest = () => {
    if (requestText.trim()) {
      onRequestSubmit(requestText.trim());
    }
  };
