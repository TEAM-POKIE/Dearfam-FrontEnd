  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="p-4 text-ba-3  rounded">main-1 배경색</div>
        <div className="p-4 bg-main-1 text-white rounded">main-2 배경색</div>
        <div className="p-4 bg-main-3 text-white rounded">main-3 배경색</div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 text-bg-2 rounded border border-gray-5">
          main-1 텍스트 색상
        </div>
        <div className="p-4 bg-bk-1 text-main-2 rounded border border-gray-5">
          main-2 텍스트 색상
        </div>
