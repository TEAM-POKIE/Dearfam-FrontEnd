...
import { mockFamilyMembers, currentFamily, generateMockFamily, generateMockFamilyMember, mockUsers, } from "../data/mockData";
// 가족 생성 - POST /family
...
const getFamilyMembersByFamilyId = http.get("/api/v1/family/members/:familyId", ({ params }) => {
...
const getFamilyMembers = http.get("/api/v1/family/members", () => {
    const response = {
        success: true,
...
const generateFamilyInviteLink = http.get("/api/v1/family/generate-link", () => {
