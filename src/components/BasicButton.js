 ...
 */
export const BasicButton = ({ text, onClick, color = "main_1", size, fullWidth = false, textStyle = "text_body3", disabled = false, }) => {
    // 색상에 따른 스타일 매핑
    const colorStyles = {
    ...
    return (_jsx("button", { onClick: onClick, disabled: disabled, style: inlineStyle, className: `
        ${colorStyles[color]} 
        h-[3.125rem]
