...
const DropdownMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (_jsx(DropdownMenuPrimitive.Trigger, { ref: ref, className: cn("outline-none ring-0 focus:outline-none focus-visible:outline-none", className), ...props, children: children })));
...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 4, ...props }, ref) => (_jsx(DropdownMenuPrimitive.Portal, { children: _jsx(DropdownMenuPrimitive.Content, { ref: ref, sideOffset: sideOffset, className: cn("z-50 w-[7.25rem] mr-[5.05rem] overflow-y-auto overflow-x-hidden rounded-[1.25rem] bg-gray-6 p-1 [box-shadow:0px_4px_4px_0px_rgba(0,0,0,0.25)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-dropdown-menu-content-transform-origin]", className), ...props }) })));
DropdownMenuContent.displayName = DropdownMenuPrimitive.Content.displayName;
const DropdownMenuItem = React.forwardRef(({ className, inset, ...props }, ref) => (_jsx(DropdownMenuPrimitive.Item, { ref: ref, className: cn("relative flex justify-center items-center gap-2 px-2 py-1.5 text-body-4", "hover:outline-none focus:outline-none focus-visible:outline-none", "hover:ring-0 focus:ring-0 focus-visible:ring-0", inset && "pl-8", className), ...props })));
